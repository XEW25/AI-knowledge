...
- [[World-Action Models]] — WAM 范式
- [[VLA - Vision-Language-Action Models]] — 端到端操控的另一分支

## Related Entities

- [[GigaAI]] — 研究机构
- [[Bi et al. - Motus A Unified Latent Action World Model]] — 对比基线
- [[Physical Intelligence - pi0.5 a VLA with Open-World Generalization]] — 对比基线
