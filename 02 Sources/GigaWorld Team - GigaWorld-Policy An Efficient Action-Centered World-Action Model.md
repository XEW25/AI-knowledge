...
1. **推理效率**：10× 快于 Motus / Cosmos Policy，0.36s/inference，满足实时高频闭环控制
2. **任务成功率**：真机平均 ~85%，比 Cosmos Policy（~55%）高 30 个百分点
3. **仿真表现**：比 π0.5 在 RoboTwin 2.0 上高 95%
4. **监督密度**：视频生成 loss 提供远超 sparse action label 的训练信号
