...
## Method deep-dive — rotation internals (code + math, 2026-06-03)
A code + math deep-dive (discussion with Ethan), reading the released repo (`github.com/UCMP13753/Omega-QVLA`) alongside the rotation algebra. Five findings; code line refs are from the cloned commit.
