...
- **L2 小脑=通用运控基座** — 小脑独立成泛化运动基座:[[Qi et al. - Humanoid-GPT (AstraBrain-WBC) Scaling Data and Structure for Zero-Shot Motion Tracking|Humanoid-GPT / AstraBrain-WBC]](Galbot,CVPR 2026,有可跑权重)、[[Guo et al. - NeuroVLA Brain-inspired Neuromorphic Cortex-Cerebellum-Spinal VLA|NeuroVLA]]、智元 BFM-2 / GCFM(厂商自报)。
